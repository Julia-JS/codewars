...
function addArrays(array1, array2) {
  ...
  let resultArray = arrayToNumber1 + arrayToNumber2 || [];
  return resultArray >= 0 ? (resultArray).toString().split('').map(a => +a) : resultArray.toString().slice(1).split('').map((a, i) => i === 0 ? -a : +a);
}
