...
// You aren't able to use any string/array/object methods, libs etc. You have to use only couple of math operators and conditionals.
// "+" and "-" operators also disabled.
